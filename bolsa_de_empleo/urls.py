...
from aplicaciones.index.views import IndexView, RegistroView, ContrasenaView, IngresarView,\
    EmpresaView, AdmonView, UsuarioView, RecuperarView, EmpresaDatosView
...
urlpatterns = patterns('',
    ...
    url(r'^empresa/datosbasicos/?$', EmpresaDatosView.as_view(), name="empresa_datos_url"),
